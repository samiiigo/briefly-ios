...
import type {
  ...
  SummarizeResult,
} from './src/BrieflyTranscriber.types';
...
export function addBrieflyTranscriberListener<
  EventName extends keyof BrieflyTranscriberModuleEvents,
>(eventName: EventName, listener: BrieflyTranscriberModuleEvents[EventName]): EventSubscription {
