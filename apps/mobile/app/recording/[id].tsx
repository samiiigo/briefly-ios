  ...
  if (recording.deletedAt != null) {
    return (
      <View style={sl.container}>
        ...
        <StackScreenHeader title={builtInFolderName('recently-deleted')} showBack onBack={goBack} />
      </View>
    );
  }
      ...
      >
        ...
        {showProcessingBanner ? (
          <View style={st.processingBanner}>
            ...
            <TouchableOpacity
              style={[st.retryButton, rerun.manualRerunButtonDisabled && st.retryButtonDisabled]}
        ...
        {recording.status === 'error' && !!recording.errorMessage && !hideAudioMissingBanner && (
