...
export function FloatingTabBar({ state, navigation }: BottomTabBarProps) {
  ...
  const { bottomOffset, horizontalInset, androidTabBarHeight, insetsBottom } =
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                ...
                isFocused && !isAndroid && (isLight ? styles.tabActiveLight : styles.tabActiveDark),
              ]}
              onPress={onPress}
              activeOpacity={0.8}
            ...
            >
              ...
              <Text
                style={[
                  ...
                  isAndroid && { marginTop: 4, fontSize: 11 },
                ]}
              >
                {config.label}
              </Text>
