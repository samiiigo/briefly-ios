...
import { initCrashReporter } from '@/core/services/crashReporter';
import { checkEnvironment } from '@/lib/utils/environment/environmentCheck';
import { installRealtimeTerminalLogs, logger } from '@/lib/utils/logging/logger';
export async function loadRecordingsOnStartup(loadRecordings: () => Promise<void>): Promise<void> {
