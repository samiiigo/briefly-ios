...
import { SCREEN_LIST_BOTTOM_PADDING } from '@/navigation/layout/screenLayout';
import { Recording } from '@briefly/types';
import { RECORDING_LIST_ITEM_GAP } from '@briefly/utils';
import { SearchTopChrome } from './SearchTopChrome';
import { RecentSearchesSection } from './RecentSearchesSection';
import { SearchFolderCard } from './SearchFolderCard';
import { SearchResultItem } from './SearchResultItem';
import { SearchEmptyState } from './SearchEmptyState';
import { SEARCH_LIST_HORIZONTAL_PADDING, getSearchScrollPaddingTop } from './searchLayout';
import {
  useCreateStyles,
  ...
  const listHeader = useMemo(() => {
    ...
    return (
      <View style={styles.listHeader}>
        ...
        {hasRecordings ? (
          <Text style={[sectionHeaderStyle, hasFolders ? styles.recordingsSectionHeader : null]}>
