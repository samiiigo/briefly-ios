import type { BuiltInFolderDef, UserFolderListFilter } from '@briefly/config';
...
export function mapBuiltInFolderTile(folder: BuiltInFolderDef, count: number): FolderTile {
  return {
    id: folder.id,
    name: folder.name,
    folderType: 'built-in',
