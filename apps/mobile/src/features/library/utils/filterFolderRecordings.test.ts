...
import { applyFavoritesOnlyFilter, filterRecordingsForFolder } from './filterFolderRecordings';
...
describe('filterRecordingsForFolder', () => {
  it('returns favorites for built-in favorites folder', () => {
    const recordings = [rec({ id: '1', isFavorite: true }), rec({ id: '2', isFavorite: false })];
