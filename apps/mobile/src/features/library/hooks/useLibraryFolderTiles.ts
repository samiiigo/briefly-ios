...
import { mapBuiltInFolderTile, type FolderTile } from '@/features/library/utils/libraryFolderModel';
export function useLibraryFolderTiles() {
  ...
  const folderCounts = useMemo(() => computeLibraryFolderCounts(recordings), [recordings]);
