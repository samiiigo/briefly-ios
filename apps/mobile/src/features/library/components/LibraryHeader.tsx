    ...
    <TopChromeOverlay>
      <View style={styles.header}>
        ...
        <View style={styles.actions}>
          <CircularIconButton icon="add" accessibilityLabel="New folder" onPress={onAddFolder} />
          <CircularIconButton icon="search" accessibilityLabel="Search" onPress={onSearch} />
        </View>
      </View>
    </TopChromeOverlay>
  );
