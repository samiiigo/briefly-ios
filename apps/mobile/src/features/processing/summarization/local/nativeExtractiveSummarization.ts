import { summarize as summarizeWithNativeModule } from '@root/modules/briefly-transcriber';
...
import { supportsNativeOnDeviceSummarization } from '@/shared/utils/platformCapabilities';
