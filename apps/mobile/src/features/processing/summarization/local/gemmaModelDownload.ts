import { createDownloadResumable, getFreeDiskStorageAsync } from 'expo-file-system/legacy';
import { LocalModelStorageService } from '@/core/services/storage/localModelStorageService';
import { logger } from '@/lib/utils/logging/logger';
import { LOCAL_GEMMA_MIN_FREE_BYTES, LOCAL_GEMMA_MODEL_DOWNLOAD_URL } from './localModelConfig';
