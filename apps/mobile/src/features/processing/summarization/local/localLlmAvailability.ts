...
import { LocalModelStorageService } from '@/core/services/storage/localModelStorageService';
import {
...
import { isLocalGemmaModelDownloaded, isLocalLlmDownloadInProgress } from './gemmaModelDownload';
import {
...
export function getLocalLlmSummarizationBlocker(mode?: ProcessingMode): string | null {
  ...
  return availability.canSummarize
    ? null
    : (availability.userMessage ?? LOCAL_LLM_MODEL_NOT_READY_MESSAGE);
}
/**
