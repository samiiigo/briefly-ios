/**
 * GeminiProvider — Gemini-specific summarization
 *
...
import { GeminiConfig } from '@briefly/config/api/gemini';
export class GeminiProvider extends CloudLLMProvider {
  ...
  protected resolveConfig(): CloudLLMConfig {
    ...
    const model: string = extra.geminiModelId ?? extra.GEMINI_MODEL_ID ?? GeminiConfig.model;
    return {
