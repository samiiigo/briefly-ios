import type { ProcessingMode, Recording } from '@briefly/types';
import { getNextSummarizationFallback } from '@/features/processing/utils/summarizationFallback';
...
export type RecordingRetryKind =
  'transcription' | 'summarization' | 'summarization-fallback' | 'full';
