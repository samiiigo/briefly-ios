...
import { scopedStorageKey, setActiveStorageUserId } from '@/core/services/storage/storageScope';
...
import { RecordingStorageService } from '@/core/services/storage/recordingStorageService';
import { FolderStorageService } from '@/core/services/storage/folderStorageService';
import {
...
export async function activateStorageScopeForUser(user: AuthUserProfile | string): Promise<void> {
