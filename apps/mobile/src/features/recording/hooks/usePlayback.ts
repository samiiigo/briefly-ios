...
import { PlaybackService } from '@/features/recording/services/audio';
import type { PlaybackControls } from '@/features/recording/services/audio';
import { TranscriptSegment } from '@briefly/types';
import { SliderAnimation } from '@briefly/theme/native';
...
export function usePlayback({
  ...
  const handleStatusUpdate = useCallback(
    (status: { position: number; duration: number; playing: boolean; didJustFinish: boolean }) => {
