...
} from '@/features/recording/services/audio';
import type { LiveTranscriptionCallbacks } from '@/features/recording/services/audio';
import type { DecorativePreviewEngine } from '@/features/processing/utils/transcriptionMode';
...
export interface DecorativeLivePreviewControllerOptions {
  ...
  callbacks: Pick<LiveTranscriptionCallbacks, 'onPartial' | 'onFinal' | 'onConnectionState'>;
