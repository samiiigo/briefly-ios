...
import { executeManualRecordingRerun } from '@/features/recording/utils/manualRecordingRerun';
...
export function canRerunSummaryFromTranscript(recording: Pick<Recording, 'transcript'>): boolean {
