...
import type { ResolvedRecordingAudio } from '@/lib/utils/fileSystem/persistRecordingAudio';
function resolveRecordingAudioOnDisk(
  ...
  const { resolveRecordingAudioOnDisk: resolve } =
    ...
    require('@/lib/utils/fileSystem/persistRecordingAudio') as typeof import('@/lib/utils/fileSystem/persistRecordingAudio');
