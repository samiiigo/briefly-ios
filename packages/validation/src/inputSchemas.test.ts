...
import { validateFolderName, validateRecordingUpdates, validateSearchQuery } from './inputSchemas';
...
describe('inputSchemas', () => {
  ...
  it('rejects unknown recording patch keys', () => {
    assert.throws(() => validateRecordingUpdates({ hackerField: 'x' }), ValidationError);
  });
