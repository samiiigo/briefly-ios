...
import { normalizeTranscriptionMode, transcriptionModeBadge } from '@/utils/transcriptionMode';
...
export default function NewRecordingScreen() {
  ...
  const transcriptionMode = normalizeTranscriptionMode(
    (params.transcriptionModeOverride as TranscriptionMode) ?? defaultTranscriptionMode,
  );
  ...
  return (
    <View style={sl.container}>
      ...
      <View style={s.recInd}>
        ...
        <Text style={[s.recTxt, isPaused && s.pTxt]}>{isPaused ? 'Paused' : 'Recording'}</Text>
      </View>
