...
import type { ResolvedRecordingAudio } from '@/shared/utils/fileSystem/persistRecordingAudio';
function resolveRecordingAudioOnDisk(
  ...
  const { resolveRecordingAudioOnDisk: resolve } =
    ...
    require('@/shared/utils/fileSystem/persistRecordingAudio') as typeof import('@/shared/utils/fileSystem/persistRecordingAudio');
