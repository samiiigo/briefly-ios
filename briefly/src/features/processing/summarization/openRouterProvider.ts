/**
 * OpenRouterProvider — OpenRouter-specific summarization
 *
...
import { OpenAIConfig } from '@/shared/constants/api/openai';
import { OpenRouterConfig } from '@/shared/constants/api/openRouter';
import { toOpenRouterOpenAIModelId } from '@/shared/constants/api/openRouterModel';
