...
import { FolderStorageService } from '@/shared/services/storage';
import type { FolderRepository } from '@/shared/services/storage';
import { generateId } from '@/shared/utils';
import { MAX_PINNED_FOLDERS } from '@/shared/constants/userFolders';
import { sortUserFolders } from '@/features/library/utils/userFolderSort';
import { validateFolderName, validateUserFolderId } from '@/shared/security/inputSchemas';
import { ValidationError } from '@/shared/security/schema';
