...
import { AudioModule, setAudioModeAsync, requestRecordingPermissionsAsync } from 'expo-audio';
...
export class ExpoAudioStreamingCapture {
  ...
  async start(
    ...
    const recorder = new AudioModule.AudioRecorder(PCM_OPTIONS) as AudioRecorder;
